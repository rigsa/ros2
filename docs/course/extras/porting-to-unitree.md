...
description: "Cómo las interfaces de ROS 2 que practicas en el TurtleBot3 Waffle se mapean a un Unitree Go2 EDU o B2."
---

Este curso enseña ROS 2 usando un
[TurtleBot3 Waffle](../../about/robots.md#robots) simulado (y, en algunos laboratorios, real).
Pero casi todo lo que escribes —
publishers/subscribers, services, actions, y las interfaces basadas en topics que usas para
controlar el robot y leer sus sensores — **no es específico de TurtleBot3**.
Es ROS 2 estándar. Si tu objetivo final es una plataforma de robot diferente — por ejemplo un
...
!!! note "El robot Go2 EDU también está disponible en el laboratorio"
    Además del TurtleBot3 Waffle utilizado en las simulaciones del curso, el laboratorio
    cuenta con un robot **Unitree Go2 EDU** real disponible para experimentación. Las
    indicaciones de esta página son especialmente relevantes si planeas trabajar con él.
...
| Interfaz del Curso | TurtleBot3 Waffle | Equivalente Unitree Go2 EDU | Equivalente Unitree B2 |
|---|---|---|---|
...
Waffle simulado en este curso. Ninguno de tu código de node necesita cambiar para esto —
es una preocupación de entorno/launch, no algo que el código `rclpy` tenga que contemplar.

## Go2 Tiene Más Grados de Libertad que el Waffle

El Waffle es de tracción diferencial: solo puede moverse hacia adelante/atrás y rotar
...
Go2 — simplemente no estás usando una capacidad que la plataforma tiene y que el Waffle no tiene.
